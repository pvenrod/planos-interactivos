...
@section('content')  
    ...
    @else
        <form method="post" action="{{route('multimedia.store',$parcela_id)}}" enctype="multipart/form-data">
    @endisset
        @csrf
        Tipo:
        <select name="tipo">
        ...
        Imagen:<input type="file" name="url"><br>
        @isset($multimedia)
            <img src="{{asset('img/multimedia/'.$multimedia->url)}}" style="width: 100px;"><br>
